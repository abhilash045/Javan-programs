...
//WAP to check if the given String 'K' is present or not ?

public class Assignment91_ {
	...
	public static void main(String[] args)
	{
		...
		boolean N1 = Name.contains("k"); //key word "Contains" used to check weather chacter present
